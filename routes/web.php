...
// Login routes with custom path '/__REDACTED_LEGACY_ADMIN_SEGMENT__' instead of '/login'
Route::get('/__REDACTED_LEGACY_ADMIN_SEGMENT__', [App\Http\Controllers\Auth\LoginController::class, 'showLoginForm'])->name('login');
