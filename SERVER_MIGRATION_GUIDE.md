...
# Or test via UI:
# Go to https://bizmark.id/__REDACTED_LEGACY_ADMIN_SEGMENT__ (login)
...
# Check login page
curl -I https://bizmark.id/__REDACTED_LEGACY_ADMIN_SEGMENT__
...
**Test Checklist:**
- [ ] Login to `/__REDACTED_LEGACY_ADMIN_SEGMENT__` works
- [ ] Dashboard loads
