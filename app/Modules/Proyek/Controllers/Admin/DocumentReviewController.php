...
class DocumentReviewController extends Controller
{
    ...
    public function reject(Request $request, $documentId)
    {
        ...
        try {
            ...
            $document->application->load('client');
            if ($document->application->client) {
                $document->application->client->notify(
                    new DocumentRequired($document->application, $document->document_type)
                );
            }
