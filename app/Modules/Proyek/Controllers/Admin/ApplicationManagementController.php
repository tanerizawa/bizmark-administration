        ...
        try {
            ...
            if ($application->client && $application->client->email) {
                try {
                    ...
                    \Illuminate\Support\FacadesLog::warning('Failed to send review start email', [
        ...
        try {
            ...
            if ($application->client && $application->client->email) {
                try {
                    ...
                    \Illuminate\Support\FacadesLog::warning('Failed to send status change email', [
                        'application_id' => $application->id,
        ...
        try {
            ...
            if ($application->client && $application->client->email) {
                try {
                    ...
                    \Illuminate\Support\FacadesLog::warning('Failed to send document revision email', [
                        'application_id' => $application->id,
                        'error' => $emailException->getMessage(),
                    ]);
                }
        ...
        try {
            ...
            $project = Project::create([
                ...
                'target_completion_date' => isset($formData['target_completion_date'])
                    ? Carbon::parse($formData['target_completion_date'])
                    : null,
