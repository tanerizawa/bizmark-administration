...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-2xl mx-auto">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-8 text-center">
            ...
            <!-- Payment Details -->
            <div class="bg-gray-50 dark:bg-gray-700/50 rounded-lg p-6 mb-6 text-left border border-gray-200 dark:border-gray-600">
                <h2 class="font-semibold text-gray-900 dark:text-white mb-4">Detail Pembayaran</h2>
                
                <div class="space-y-3">
                    <div class="flex justify-between">
                        <span class="text-gray-600 dark:text-gray-400">No. Pembayaran</span>
                        <span class="font-semibold text-gray-900 dark:text-white">{{ $payment->payment_number }}</span>
                    </div>
                    
                    <div class="flex justify-between">
                        <span class="text-gray-600 dark:text-gray-400">No. Aplikasi</span>
                        <span class="font-semibold text-gray-900 dark:text-white">{{ $application->application_number }}</span>
                    </div>
                    
                    <div class="flex justify-between">
                        <span class="text-gray-600 dark:text-gray-400">Jumlah</span>
                        <span class="font-bold text-lg text-gray-900 dark:text-white">Rp {{ number_format($payment->amount, 0, ',', '.') }}</span>
                    </div>
                    ...
                    <div class="flex justify-between">
                        ...
                        <span class="px-3 py-1 rounded-full text-sm font-semibold
                            ...
                            @elseif($payment->status === 'processing') bg-yellow-100 text-yellow-800 dark:bg-yellow-900/30 dark:text-yellow-400
                    ...
                    <div class="flex justify-between">
                        ...
                        <span class="font-semibold text-gray-900 dark:text-white">{{ $payment->created_at->format('d M Y H:i') }}</span>
                    </div>
                </div>
            </div>

            <!-- Next Steps -->
            <div class="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-6 mb-6 text-left border border-blue-200 dark:border-blue-800">
                <h3 class="font-semibold text-gray-900 dark:text-white mb-3">
                    <i class="fas fa-info-circle text-blue-600 dark:text-blue-400 mr-2"></i>Langkah Selanjutnya
                </h3>
            ...
            <div class="flex gap-3">
                ...
                <a href="{{ route('client.dashboard') }}" 
                   class="flex-1 px-6 py-3 bg-gray-200 dark:bg-gray-700 text-gray-700 dark:text-gray-200 font-semibold rounded-lg hover:bg-gray-300 dark:hover:bg-gray-600 transition">
