@php
    ...
    // Status icon mapping (only icon is used — badge colors come from client.css status-badge--* classes)
    $statusIcons = [
        'draft'               => 'fa-file-alt',
    ...
    $statusMeta = ['icon' => $statusIcons[$application->status] ?? 'fa-file-alt'];
...
<!-- Mobile Quick Navigation Tabs (sticky, anchor-based) -->
<div class="lg:hidden sticky top-14 z-30 bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-700 overflow-x-auto scrollbar-hide">
    <div class="flex gap-0 min-w-max px-0">
        @foreach([
            ['href' => '#section-info',  'icon' => 'fa-info-circle',  'label' => 'Ringkasan'],
            ['href' => '#section-docs',  'icon' => 'fa-paperclip',    'label' => 'Dokumen'],
            ['href' => '#section-comm',  'icon' => 'fa-comments',     'label' => 'Komunikasi'],
            ['href' => '#section-log',   'icon' => 'fa-history',      'label' => 'Riwayat'],
        ] as $tab)
        <a href="{{ $tab['href'] }}"
           class="flex flex-col items-center justify-center gap-0.5 px-5 py-2.5 text-[11px] font-semibold text-gray-500 dark:text-gray-400 hover:text-[#0a66c2] dark:hover:text-blue-400 border-b-2 border-transparent hover:border-[#0a66c2] transition-all min-h-[44px]">
...
<div class="max-w-7xl mx-auto px-4 lg:px-6 py-6">
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2 space-y-1">
            ...
            <!-- Application Info -->
    <div id="section-info" class="bg-white dark:bg-gray-800 border-y border-gray-200 dark:border-gray-700 scroll-mt-28 lg:scroll-mt-0">
    ...
    <div class="bg-white dark:bg-gray-800 border-y border-gray-200 dark:border-gray-700">
        ...
        <!-- Documents -->
        <div id="section-docs" class="bg-white dark:bg-gray-800 border-y border-gray-200 dark:border-gray-700 scroll-mt-28 lg:scroll-mt-0">
                        ...
                        <div class="flex items-center justify-between py-3 hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
                            ...
                            <div class="flex items-center gap-2">
                                ...
                                <form method="POST"
                                      ...
                                      x-data @submit.prevent="if(confirm('Yakin ingin menghapus dokumen ini?')) $el.submit()">
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit" 
        ...
        <div id="section-log" class="bg-white dark:bg-gray-800 border-y border-gray-200 dark:border-gray-700 scroll-mt-28 lg:scroll-mt-0">
            <div class="px-4 lg:px-6 py-4 border-b border-gray-100 dark:border-gray-700">
                <h2 class="text-sm font-bold text-gray-900 dark:text-white flex items-center">
        ...
        <div id="section-comm" class="bg-white dark:bg-gray-800 border-y border-gray-200 dark:border-gray-700 scroll-mt-28 lg:scroll-mt-0">
            <div class="px-4 lg:px-6 py-4 border-b border-gray-100 dark:border-gray-700">
                <h2 class="text-sm font-bold text-gray-900 dark:text-white flex items-center">
