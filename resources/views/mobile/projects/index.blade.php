    ...
    <div class="sticky top-14 z-10 bg-white border-b border-gray-200 safe-top">
        <div class="flex overflow-x-auto scrollbar-hide">
            <button @click="filterStatus('active')" 
                    :class="currentStatus === 'active' ? 'border-[#0A66C2] text-[#0A66C2]' : 'border-transparent text-gray-500'"
    ...
    <div class="p-4 bg-gray-50">
        <div class="relative">
            ...
            <input type="search" 
                   ...
                   class="w-full pl-10 pr-4 py-2.5 bg-white border border-gray-200 rounded-lg focus:ring-2 focus:ring-[#0A66C2] focus:border-transparent">
        </div>
    </div>
                        ...
                        <div class="flex-1 min-w-0 pr-3">
                            ...
                            <template x-if="project.client">
                                <div class="flex items-center gap-1 mt-1">
                                    <i class="fas fa-building text-[#0A66C2] text-xs"></i>
                                    <p class="text-xs text-[#0A66C2] font-medium truncate" x-text="project.client.company_name"></p>
                                </div>
                            </template>
                        </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="h-1.5 bg-gray-200 rounded-full overflow-hidden">
                            <div :style="`width: ${project.progress || 0}%`" 
                                 class="h-full bg-[#0A66C2] transition-all duration-300"></div>
                        </div>
                    </div>
