        ...
        <div class="container mx-auto max-w-6xl">
            ...
            <div class="grid md:grid-cols-3 gap-8 mb-8" data-neural-group="primary-services">
                ...
                <article class="feature-card" data-neural-priority="highest">
                    ...
                    <ul class="space-y-2 text-sm mb-5" style="color: var(--dark-text-secondary);">
                    ...
                    {{-- Price anchors --}}
                    <div class="pt-4" style="border-top:1px solid var(--dark-separator);">
                        <p class="text-xs mb-2 font-semibold" style="color:var(--dark-text-secondary);">Estimasi biaya mulai dari:</p>
                        <div class="flex flex-wrap gap-2 mb-3">
                            <span class="text-xs px-2 py-1 rounded-full" style="background:rgba(22,163,74,.12);color:var(--color-success);">
                        ...
                        <a href="{{ app()->getLocale() === 'en' ? route('services.index.en') : route('services.index.id') }}" class="text-xs font-semibold" style="color:var(--color-primary);">
