...
<head>
    ...
    <script type="application/ld+json">
    {
        ...
        "description": "Trusted business licensing consultant in Indonesia. Specialists in Environmental Impact Assessment, permits, and PMA/PT company establishment.",
        "url": "https://bizmark.id/en",
            ...
            "itemListElement": [
                ...
                },
                {
                    ...
                    "itemOffered": {
                        ...
                        "description": "AMDAL document preparation and environmental permit services"
                    }
                },
                {
                    "@@type": "Offer",
                    "itemOffered": {
                        ...
                        "description": "Complete business licensing and permit solutions"
                    }
                }
            ]
        }
    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between h-16">
            ...
            <div class="hidden md:flex items-center space-x-1">
                ...
                <a href="{{ route('blog.index.en') }}" class="nav-link">{{ __('landing.nav.blog') }}</a>
    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div class="group card animate-fade-in delay-{{ ($loop->index % 3 + 1) * 100 }}">
                ...
                <a href="{{ route('services.show.en', $slug) }}" class="inline-flex items-center text-blue-900 font-semibold hover:text-blue-700 transition group">
        ...
        <div class="grid lg:grid-cols-2 gap-12 items-center">
            <div class="animate-fade-in">
                ...
                <h2 class="text-3xl md:text-4xl font-bold mb-6 text-gray-900">
                    Your Trusted Partner for Business Success in Indonesia
                </h2>
                <p class="text-lg text-gray-600 mb-6">
                    PT Cangah Pajaratan Mandiri (Bizmark.ID) has been serving foreign investors and multinational companies for over 15 years. We specialize in navigating Indonesia's complex regulatory landscape to help you establish and grow your business smoothly.
                </p>
                <p class="text-gray-600 mb-6">
                    Our team of certified consultants brings extensive experience in handling permits for various industries across Indonesia. We work closely with government agencies including BKPM, Ministry of Environment, and local authorities to ensure your compliance and operational readiness.
                </p>
                ...
                <div class="grid sm:grid-cols-2 gap-6 mb-8">
                    <div class="flex items-start gap-3">
                        ...
                        <div>
                            <h4 class="font-bold text-gray-900 mb-1">ISO Certified</h4>
                            <p class="text-sm text-gray-600">Quality management system certified</p>
                        </div>
                    </div>
                    <div class="flex items-start gap-3">
                        ...
                        <div>
                            <h4 class="font-bold text-gray-900 mb-1">Expert Team</h4>
                            <p class="text-sm text-gray-600">Certified environmental consultants</p>
                        </div>
                    </div>
                    <div class="flex items-start gap-3">
                        ...
                        <div>
                            <h4 class="font-bold text-gray-900 mb-1">500+ Clients</h4>
                            <p class="text-sm text-gray-600">Trusted by international companies</p>
                        </div>
                    </div>
                    <div class="flex items-start gap-3">
                        ...
                        <div>
                            <h4 class="font-bold text-gray-900 mb-1">Nationwide</h4>
                            <p class="text-sm text-gray-600">Service coverage across Indonesia</p>
                        </div>
                    </div>
                </div>

                <div class="flex flex-wrap gap-4">
                    <a href="{{ route('pma.inquiry.create') }}" class="btn btn-primary">
            ...
            <div class="relative">
                <div class="aspect-[4/3] bg-gradient-to-br from-blue-100 to-blue-50 rounded-2xl overflow-hidden">
                    <div class="absolute inset-0 flex items-center justify-center">
                        <div class="text-center p-8">
                            ...
                            <h3 class="text-2xl font-bold text-blue-900 mb-2">15+ Years</h3>
                            <p class="text-blue-700">Serving Foreign Investors</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="absolute -top-6 -right-6 bg-white p-6 rounded-xl shadow-xl border border-gray-100">
                    <div class="text-4xl font-bold text-green-600">$2B+</div>
                    <div class="text-sm text-gray-600">Investment Facilitated</div>
                </div>
            </div>
        </div>
    </div>
