                ...
                <div class="space-y-6">
                    <div>
                        ...
                        <textarea 
                            ...
                            class="w-full px-4 py-3 rounded-apple text-sm text-dark-text-primary focus:outline-none focus:ring-2 focus:ring-apple-blue" 
                            style="background: var(--dark-bg-tertiary); border: 1px solid var(--dark-separator);">{{ old('generation_notes') }}</textarea>
                        <p class="mt-2 text-xs text-dark-text-tertiary">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <select 
                                ...
                                class="w-full px-4 py-3 rounded-apple text-sm text-dark-text-primary focus:outline-none focus:ring-2 focus:ring-apple-blue" 
                                style="background: var(--dark-bg-tertiary); border: 1px solid var(--dark-separator);">
                                <option value="local" {{ old('target_market', 'local') === 'local' ? 'selected' : '' }}>Local (UMKM, CV, PT Lokal)</option>
                                <option value="pma" {{ old('target_market') === 'pma' ? 'selected' : '' }}>PMA / Foreign Investment</option>
                                <option value="both" {{ old('target_market') === 'both' ? 'selected' : '' }}>Both</option>
                            </select>
                        </div>
                    </div>
                </div>
