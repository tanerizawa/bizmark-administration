...
<head>
    ...
    <meta name="description" content="Masuk ke portal Bizmark.ID untuk mengelola perizinan usaha Anda.">
            ...
            <div class="px-8 pb-8">
                ...
                @if (Route::has('client.register'))
                    <a href="{{ route('client.register') }}"
                       class="btn-outline block w-full text-center py-3 px-4 font-semibold rounded-lg transition">
