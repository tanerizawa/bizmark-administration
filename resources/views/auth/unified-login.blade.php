...
<head>
    ...
    <meta name="description" content="Masuk ke portal klien Bizmark.ID untuk melihat status layanan, dokumen, dan pembaruan proyek Anda.">
        ...
        <section class="auth-panel">
            ...
            <div class="auth-content px-5 pb-5">
                ...
                <form method="POST" action="{{ route('login') }}" class="space-y-3" novalidate>
                    ...
                    <div class="flex items-center justify-between text-sm">
                        ...
                        @if (Route::has('client.password.request'))
                            <a href="{{ route('client.password.request') }}" class="font-medium back-link">Lupa password?</a>
                        @endif
                    </div>
                ...
                @if (Route::has('client.register'))
                    <a href="{{ route('client.register') }}" class="btn-outline block w-full text-center py-2.5 px-4 mt-3 text-sm font-semibold rounded-lg transition">
