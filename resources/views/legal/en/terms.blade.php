    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        <div class="max-w-6xl mx-auto">
            ...
            <div id="introduction" class="scroll-mt-24">
                ...
                <p class="text-lg leading-relaxed">Welcome to <strong>Bizmark.ID</strong>, a service operated by <strong>PT Cangah Pajaratan Mandiri</strong>. These Terms and Conditions (<strong>"Terms"</strong>) govern your use of our industrial permit and environmental consultation services.</p>
                <p>By engaging our services, you agree to be bound by these Terms. Please read them carefully before proceeding with any service request.</p>
            </div>
