...
<section class="section-sm" style="background:var(--surface-dark);">
    <div class="container-wide text-center">
        <h2 class="text-white mb-3" style="font-size:clamp(1.5rem,3vw,2.1rem);font-weight:750;">Siap Memulai Kerja Sama?</h2>
        <p class="mb-7" style="color:rgba(255,255,255,.74);">Konsultasikan kebutuhan perizinan Anda dengan tim ahli kami.</p>
