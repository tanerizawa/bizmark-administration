        ...
        <div class="flex items-center justify-between h-20">
            ...
            <div class="hidden md:flex items-center space-x-6">
                ...
                <div class="flex items-center gap-4 border-l pl-6">
                    ...
                    <a href="/__REDACTED_LEGACY_ADMIN_SEGMENT__" class="login-btn">Login</a>
...
**Solution:** Add "Login Client" button → link ke /__REDACTED_LEGACY_ADMIN_SEGMENT__ atau client portal
