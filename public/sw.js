...
const CACHE_VERSION = 'v2.5.0'; // Updated for mobile admin
const BUILD_TIMESTAMP = '2025-11-18T10:00:00Z'; // Auto-generated on build
...
self.addEventListener('fetch', (event) => {
  ...
  if (url.pathname.startsWith('/admin') || 
      url.pathname.startsWith('/__REDACTED_LEGACY_ADMIN_SEGMENT__') ||
